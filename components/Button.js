...
const Button = ({children, onPress, style, size}) => {


    return (
        <View style={style}>
        <ImageBackground source={require("../assets/backgrounds/buttonBackground.png")} style={styles.bg}>
            <Pressable onPress={onPress} android_disableSound={true}>
                ...
                }} numberOfLines={1} adjustsFontSizeToFit={true} >{children}</Text>
            </Pressable>
        </ImageBackground>
        </View>
    )
