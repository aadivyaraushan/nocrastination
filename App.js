...
import OrganisationPage from './screens/OrganisationPage';
...
export default function App() {
    ...
    const questProviderValue = useMemo(() => ({ quest, setQuest }), [quest, setQuest]);
...
LogBox.ignoreLogs(['Setting a timer', 'Async storage has been extracted']);
